...
BOT_USERNAME = environ.get("BOT_USERNAME", "Mikasa_Forward_Bot") # without @
...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://misssiyaofficial:zzx4322CU68rU8gw@cluster0.frhwbd1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002630469734"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://sahilbhakabachapregnanthai-2210cdf88196.herokuapp.com/")
